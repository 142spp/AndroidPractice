...
public class GalleryActivity extends AppCompatActivity {
    ...
    public static final int GALLEY_IMAGE_REQUEST_CODE = 1;
    ...
    private void getImageFromGallery(){
        ...
        startActivityForResult(intent,GALLEY_IMAGE_REQUEST_CODE);
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data){
        ...
        if(resultCode == Activity.RESULT_OK &&
            requestCode == GALLEY_IMAGE_REQUEST_CODE){
            if(data==null) return;
            ...
            if(bitmap!=null){
                Pair<String,Float> result = cls.classify(bitmap);
                String resultStr = String.format(
                        Locale.ENGLISH,
                        "class: %s, prob:%.0f%%",
                        result.first,
                        result.second*100.0f
                );
