...
import com.example.week13_3.tflite.Classifier;
...
public class GalleryActivity extends AppCompatActivity {
    String[] categories = {"T-shirt/top","Trouser","Pullover","Dress","Coat","Sandal","Shirt","Sneaker","Bag","Ankle boot"};
